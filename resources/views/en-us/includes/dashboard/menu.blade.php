<div class="dashboard_section_row_lft">
    ...
    <div class="dashboard_sidebar">
        <div class="dashboard_sliderbar_menu">
            <a href="{{ locale_route('dashboard')}}" class="dashboard_menu_item {{ Route::is('locale.dashboard') ? 'dashboard_active' : '' }}">
            ...
            <a href="{{ locale_route('profile')}}" class="dashboard_menu_item {{ request()->is('*dashboard/profile') ? 'dashboard_active' : '' }}">
                <div class="dashboard_menu_item_img">
            ...
            <a href="{{ locale_route('registerorg')}}" class="dashboard_menu_item {{ Route::is('locale.registerorg') ? 'dashboard_active' : '' }}">
                <div class="dashboard_menu_item_img">
            ...
            <a href="{{ locale_route('knowledgebase')}}" class="dashboard_menu_item {{ Route::is('locale.knowledgebase') ? 'dashboard_active' : '' }}">
                <div class="dashboard_menu_item_img">
            ...
            <a href="{{ locale_route('change-password') }}" class="dashboard_menu_item {{ Route::is('locale.change-password') ? 'dashboard_active' : '' }}">
                <div class="dashboard_menu_item_img">
            ...
            <a href="{{ locale_route('logout') }}" class="dashboard_menu_item {{ Route::is('logout') ? 'dashboard_active' : '' }}">
                <div class="dashboard_menu_item_img">
