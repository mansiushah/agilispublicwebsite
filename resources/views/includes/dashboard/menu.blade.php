 @php
    ...
    // Example: en-us, en-au, en-ca, en-gb
    $currentLocale = request()->route('locale');

    // Full path => e.g. "en-ca/dashboard/profile"
    $currentPath = request()->path();

    // Remove locale prefix (en-ca/, en-us/, etc.)
    if ($currentLocale) {
        $currentPath = Str::after($currentPath, $currentLocale . '/');
    }

    // If user is on default site (/dashboard), keep path as is
    if (!$currentLocale) {
...
<div class="dashboard_section_row_lft">
    ...
    <div class="dashboard_sidebar">
        <div class="dashboard_sliderbar_menu">
            <a href="{{ locale_route('dashboard') }}" class="dashboard_menu_item {{ Route::is('dashboard') ? 'dashboard_active' : '' }}">
            ...
            <a href="{{ locale_route('profile') }}" class="dashboard_menu_item {{ Route::is('profile') ? 'dashboard_active' : '' }}">
                <div class="dashboard_menu_item_img">
            ...
            <a href="{{ locale_route('change-password') }}" class="dashboard_menu_item {{ Route::is('change-password') ? 'dashboard_active' : '' }}">
                <div class="dashboard_menu_item_img">
