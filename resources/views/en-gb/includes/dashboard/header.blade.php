        ...
        <div class="container">
            <nav class="navbar navbar-expand-md">
                <div class="d-flex align-items-center">
                    ...
                    <a href="#" class="dashboard_sidebar_menu_toggle ml-2"><img
                            src="{{ url('public/assets/img/sidebar-menu-bar.png')}}" alt="sidebar-menu-bar" class="img-fluid">
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="Dashboard-One.html    ">Home</a>
                        </li>
                        <li class="nav-item">
